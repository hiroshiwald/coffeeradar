...
The middleware was never the problem — it correctly blocked unauthenticated requests.
The problem was downstream: the login endpoint had no valid credentials to check against.
