// Static vocabulary and patterns used by heuristics.ts.
// Kept in a separate module so heuristics.ts focuses on logic, not data.
...
export const PROCESS_MAP: readonly [RegExp, string][] = [
...
export const NOTE_PATTERNS: readonly RegExp[] = [
...
// Words that describe texture/character rather than flavor.
// Used to demote them when we already have enough flavor notes.
export const TEXTURE_NOTE_WORDS: ReadonlySet<string> = new Set([
...
export const MERCH_KEYWORDS: readonly string[] = [
...
export const MERCH_PRODUCT_TYPES: readonly string[] = [
